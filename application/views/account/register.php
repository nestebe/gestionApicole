...
<html>
  <head>
    ...
    <title>Beehope | Inscription</title>
  ...
  <body class="hold-transition register-page">
    <div class="register-box">
      ...
      <div class="register-box-body">
        ...
        <form id="formRegister" action="<?=base_url()."account/new_user"?>" method="post">
          ...
          <div class="form-group has-feedback">
            <input type="password" class="form-control" placeholder="Valider le mot de passe" name="password_confirm">
...
<!--            <div class="col-xs-8">
            ...
            <div class="col-xs-4">
              <button type="submit" class="btn btn-primary btn-block btn-flat pull-right">Inscription</button>
            </div><!-- /.col -->
          </div>
        </form>
...
<!--        <a href="login.html" class="text-center">J'ai un compte</a>-->
      </div><!-- /.form-box -->
    </div><!-- /.register-box -->
    <!-- jQuery 2.1.4 -->
